...
if st.button("Dự đoán"):
    ...
    ax_train.scatter(y_train, linear_model.predict(X_train_scaled), edgecolors=(0, 0, 0))
    ...
    ax_test.scatter(y_test, linear_model.predict(X_test_scaled), edgecolors=(0, 0, 0))
